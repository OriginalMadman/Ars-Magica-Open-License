...
* In the **reviewed** folder, you'll find Markdown files that has had at least one full manual pass & review and the official errata added. There may still be minor things that need correction and additional review passes (please submit corrections). The completion state is indicated at the beginning of the document.
